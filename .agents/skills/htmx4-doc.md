...
```html
<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.js" integrity="sha384-Fdc3B0lizDjmax4pRwqtRjysF8+FsHjMl1s9CkyTqt/AUi4ynHiWYaqaenPgg6z6" crossorigin="anonymous"></script>
```

#### ES Module

```html
<script type="module" src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.esm.min.js" integrity="sha384-ERqk7hevrCKBwe/kfA8k80NbgORfLhP48wNROosqmzJpUnEl7X41L0Hi66QK9DbH" crossorigin="anonymous"></script>
```

#### ES Module (unminified)

```html
<script type="module" src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.esm.js" integrity="sha384-58txKqTH7i+ZG0EJ/zZZN3dZvib83oqs6rMOBUCk0VjuOPxwg8TnbT5/zWbjIitR" crossorigin="anonymous"></script>
```
...
1. Download <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.min.js">htmx.min.js</a>
...
Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.js">htmx.js</a> (unminified)

Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.esm.min.js">htmx.esm.min.js</a> (ES module)

Download: <a download href="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.esm.js">htmx.esm.js</a> (ES module, unminified)
...
* [`hx-sse`](https://four.htmx.org/extensions/hx-sse)
* [`hx-ws`](https://four.htmx.org/extensions/hx-ws)
* [`hx-preload`](https://four.htmx.org/extensions/hx-preload)
* [`hx-browser-indicator`](https://four.htmx.org/extensions/hx-browser-indicator)
* [`hx-download`](https://four.htmx.org/extensions/hx-download)
* [`hx-optimistic`](https://four.htmx.org/extensions/hx-optimistic)
* [`hx-targets`](https://four.htmx.org/extensions/hx-targets)
* [`hx-live`](https://four.htmx.org/extensions/hx-live)
* [`hx-upsert`](https://four.htmx.org/extensions/hx-upsert)
* [`hx-alpine-compat`](https://four.htmx.org/extensions/hx-alpine-compat)
* [`hx-history-cache`](https://four.htmx.org/extensions/hx-history-cache) _(included but disabled by default)_
...
npx htmx.org@4.0.0-beta6 upgrade-check --ext .vue ./path/to/project/root
```
...
Do the `hx-disable` rename **before** upgrading. In htmx 2, `hx-disable` meant "skip htmx processing on this element". In htmx 4, that role is [`hx-ignore`](https://four.htmx.org/reference/attributes/hx-ignore), and `hx-disable` now does what `hx-disabled-elt` used to do.

| htmx 2.x          | htmx 4.x                                                                                           | Type    | Notes                                                                                              |
|-------------------|----------------------------------------------------------------------------------------------------|---------|----------------------------------------------------------------------------------------------------|
| [`hx-disable`](https://htmx.org/attributes/hx-disable/)           | [`hx-ignore`](https://four.htmx.org/reference/attributes/hx-ignore)                                                     | renamed | Rename this first to avoid conflicts.                                                              |
| [`hx-disabled-elt`](https://htmx.org/attributes/hx-disabled-elt/) | [`hx-disable`](https://four.htmx.org/reference/attributes/hx-disable)                                                   | renamed | Rename this after `hx-disable` becomes `hx-ignore`.                                                |
| [`hx-vars`](https://htmx.org/attributes/hx-vars/)                 | [`hx-vals`](https://four.htmx.org/reference/attributes/hx-vals)                                                         | removed | Use the `js:` prefix.                                                                              |
| [`hx-params`](https://htmx.org/attributes/hx-params/)             | [`htmx:config:request`](https://four.htmx.org/reference/events/htmx-config-request)                                     | removed | Configure request parameters in the event.                                                         |
| [`hx-prompt`](https://htmx.org/attributes/hx-prompt/)             | [`hx-prompt` extension](https://four.htmx.org/extensions/hx-prompt)                                                     | removed | You can also use a [one-liner with `hx-on`](https://four.htmx.org/extensions/hx-prompt#without-the-extension).          |
...
| [`hx-request`](https://htmx.org/attributes/hx-request/)           | [`hx-config`](https://four.htmx.org/reference/attributes/hx-config)                                                     | removed | —                                                                                                  |
...
All events follow a new pattern: `htmx:phase:action[:sub-action]`. Most error events are consolidated to [`htmx:error`](https://four.htmx.org/reference/events/htmx-error). HTTP error responses use [`htmx:response:error`](https://four.htmx.org/reference/events/htmx-response-error).

| htmx 2.x                    | htmx 4.x                                                                          | Type    | Notes                               |
|-----------------------------|-----------------------------------------------------------------------------------|---------|-------------------------------------|
| `htmx:afterOnLoad`          | [`htmx:after:init`](https://four.htmx.org/reference/events/htmx-after-init)                            | renamed | —                                   |
| `htmx:afterProcessNode`     | [`htmx:after:init`](https://four.htmx.org/reference/events/htmx-after-init)                            | renamed | —                                   |
| `htmx:afterRequest`         | [`htmx:after:request`](https://four.htmx.org/reference/events/htmx-after-request)                      | renamed | —                                   |
| `htmx:afterSettle`          | [`htmx:after:settle`](https://four.htmx.org/reference/events/htmx-after-settle)                        | renamed | —                                   |
| `htmx:afterSwap`            | [`htmx:after:swap`](https://four.htmx.org/reference/events/htmx-after-swap)                            | renamed | —                                   |
| `htmx:beforeCleanupElement` | [`htmx:before:cleanup`](https://four.htmx.org/reference/events/htmx-before-cleanup)                    | renamed | —                                   |
| `htmx:beforeHistorySave`    | [`htmx:before:history:update`](https://four.htmx.org/reference/events/htmx-before-history-update)      | renamed | —                                   |
| `htmx:beforeOnLoad`         | [`htmx:before:init`](https://four.htmx.org/reference/events/htmx-before-init)                          | renamed | —                                   |
| `htmx:beforeProcessNode`    | [`htmx:before:process`](https://four.htmx.org/reference/events/htmx-before-process)                    | renamed | —                                   |
| `htmx:beforeRequest`        | [`htmx:before:request`](https://four.htmx.org/reference/events/htmx-before-request)                    | renamed | —                                   |
| `htmx:beforeSwap`           | [`htmx:before:swap`](https://four.htmx.org/reference/events/htmx-before-swap)                          | renamed | —                                   |
| `htmx:configRequest`        | [`htmx:config:request`](https://four.htmx.org/reference/events/htmx-config-request)                    | renamed | —                                   |
| `htmx:historyCacheMiss`     | [`htmx:before:history:restore`](https://four.htmx.org/reference/events/htmx-before-restore-history)    | renamed | —                                   |
| `htmx:historyRestore`       | [`htmx:before:history:restore`](https://four.htmx.org/reference/events/htmx-before-restore-history)    | renamed | —                                   |
| `htmx:load`                 | [`htmx:after:init`](https://four.htmx.org/reference/events/htmx-after-init)                            | renamed | —                                   |
| `htmx:oobAfterSwap`         | [`htmx:after:swap`](https://four.htmx.org/reference/events/htmx-after-swap)                            | renamed | —                                   |
| `htmx:oobBeforeSwap`        | [`htmx:before:swap`](https://four.htmx.org/reference/events/htmx-before-swap)                          | renamed | —                                   |
| `htmx:pushedIntoHistory`    | [`htmx:after:history:push`](https://four.htmx.org/reference/events/htmx-after-push-into-history)       | renamed | —                                   |
| `htmx:replacedInHistory`    | [`htmx:after:history:replace`](https://four.htmx.org/reference/events/htmx-after-replace-into-history) | renamed | —                                   |
| `htmx:responseError`        | [`htmx:response:error`](https://four.htmx.org/reference/events/htmx-response-error)                    | renamed | HTTP error responses use this event. |
| `htmx:sendError`            | [`htmx:error`](https://four.htmx.org/reference/events/htmx-error)                                      | renamed | —                                   |
| `htmx:swapError`            | [`htmx:error`](https://four.htmx.org/reference/events/htmx-error)                                      | renamed | —                                   |
| `htmx:targetError`          | [`htmx:error`](https://four.htmx.org/reference/events/htmx-error)                                      | renamed | —                                   |
| `htmx:timeout`              | [`htmx:error`](https://four.htmx.org/reference/events/htmx-error)                                      | renamed | —                                   |
...
| `htmx:xhr:loadend`          | [`htmx:finally:request`](https://four.htmx.org/reference/events/htmx-finally-request)                  | removed | htmx uses `fetch()` now.             |
| `htmx:xhr:progress`         | —                                                                                 | removed | htmx uses `fetch()` now.             |
| `htmx:xhr:abort`            | [`htmx:error`](https://four.htmx.org/reference/events/htmx-error)                                      | removed | htmx uses `fetch()` now.             |

#### Config

| htmx 2.x                 | htmx 4.x                                                                   | Type            | Notes                                                                                                                                                |
|--------------------------|----------------------------------------------------------------------------|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| `defaultSwapStyle`       | [`defaultSwap`](https://four.htmx.org/reference/config/htmx-config-defaultSwap)                 | renamed         | —                                                                                                                                                    |
| `globalViewTransitions`  | [`transitions`](https://four.htmx.org/reference/config/htmx-config-transitions)                 | renamed         | —                                                                                                                                                    |
| `historyEnabled`         | [`history`](https://four.htmx.org/reference/config/htmx-config-history)                         | renamed         | —                                                                                                                                                    |
| `includeIndicatorStyles` | [`includeIndicatorCSS`](https://four.htmx.org/reference/config/htmx-config-includeIndicatorCSS) | renamed         | —                                                                                                                                                    |
| `timeout`                | [`defaultTimeout`](https://four.htmx.org/reference/config/htmx-config-defaultTimeout)           | renamed         | —                                                                                                                                                    |
...
| `disableSelector`        | [`hx-ignore`](https://four.htmx.org/reference/attributes/hx-ignore)                             | removed         | —                                                                                                                                                    |
| `getCacheBusterParam`    | —                                                                          | removed         | —                                                                                                                                                    |
| `historyCacheSize`       | —                                                                          | removed         | —                                                                                                                                                    |
| `ignoreTitle`            | —                                                                          | removed         | Still works per swap via [`hx-swap`](https://four.htmx.org/reference/attributes/hx-swap)`="... ignoreTitle:true"`.                                                     |
...
| `responseHandling`       | [`hx-status`](https://four.htmx.org/reference/attributes/hx-status)                             | removed         | Use with [`noSwap`](https://four.htmx.org/reference/config/htmx-config-noSwap).                                                                                          |
| `scrollBehavior`         | —                                                                          | removed         | —                                                                                                                                                    |
| `scrollIntoViewOnBoost`  | —                                                                          | removed         | —                                                                                                                                                    |
| `selfRequestsOnly`       | [`htmx.config.mode`](https://four.htmx.org/reference/config/htmx-config-mode)                   | removed         | —                                                                                                                                                    |
...
| `withCredentials`        | [`hx-config`](https://four.htmx.org/reference/attributes/hx-config)                             | removed         | —                                                                                                                                                    |
...
| htmx 2.x          | htmx 4.x                                                | Type            | Notes                                                 |
|-------------------|---------------------------------------------------------|-----------------|-------------------------------------------------------|
| `HX-Trigger`      | [`HX-Source`](https://four.htmx.org/reference/headers/HX-Source)             | changed format  | Format is `tagName#id`, e.g. `button#submit`.        |
| `HX-Target`       | [`HX-Target`](https://four.htmx.org/reference/headers/HX-Target)             | changed format  | Format is `tagName#id`.                              |
| `HX-Trigger-Name` | [`HX-Source`](https://four.htmx.org/reference/headers/HX-Source)             | removed         | —                                                     |
| `HX-Prompt`       | [`hx-prompt` extension](https://four.htmx.org/extensions/hx-prompt)          | restored by ext | Load the extension.                                   |
| —                 | [`HX-Request-Type`](https://four.htmx.org/reference/headers/HX-Request-Type) | new             | `"full"` or `"partial"`.                          |
| —                 | `Accept`                                                | new             | Core requests send `text/html`; [`hx-sse`](https://four.htmx.org/extensions/hx-sse#request-headers) adds `text/event-stream`. |

#### Response headers

| htmx 2.x                 | htmx 4.x                                      | Type      | Notes                           |
|--------------------------|-----------------------------------------------|-----------|---------------------------------|
| `HX-Trigger-After-Swap`  | [`HX-Trigger`](https://four.htmx.org/reference/headers/HX-Trigger) | removed   | You can also use JavaScript.    |
| `HX-Trigger-After-Settle`| [`HX-Trigger`](https://four.htmx.org/reference/headers/HX-Trigger) | removed   | You can also use JavaScript.    |
| `HX-Trigger`             | [`HX-Trigger`](https://four.htmx.org/reference/headers/HX-Trigger) | unchanged | —                               |
| `HX-Location`            | [`HX-Location`](https://four.htmx.org/reference/headers/HX-Location) | unchanged | —                             |
| `HX-Push-Url`            | [`HX-Push-Url`](https://four.htmx.org/reference/headers/HX-Push-Url) | unchanged | —                             |
| `HX-Redirect`            | [`HX-Redirect`](https://four.htmx.org/reference/headers/HX-Redirect) | unchanged | —                             |
| `HX-Refresh`             | [`HX-Refresh`](https://four.htmx.org/reference/headers/HX-Refresh) | unchanged | —                               |
| `HX-Replace-Url`         | [`HX-Replace-Url`](https://four.htmx.org/reference/headers/HX-Replace-Url) | unchanged | —                       |
| `HX-Retarget`            | [`HX-Retarget`](https://four.htmx.org/reference/headers/HX-Retarget) | unchanged | —                             |
| `HX-Reswap`              | [`HX-Reswap`](https://four.htmx.org/reference/headers/HX-Reswap)   | unchanged | —                               |
| `HX-Reselect`            | [`HX-Reselect`](https://four.htmx.org/reference/headers/HX-Reselect) | unchanged | —                             |
...
| `htmx.onLoad()`          | `htmx.onLoad()`               | changed   | Now listens on [`htmx:after:process`](https://four.htmx.org/reference/events/htmx-after-process), not [`htmx:after:init`](https://four.htmx.org/reference/events/htmx-after-init). |
...
| Attribute                                          | Purpose                                                               |
|----------------------------------------------------|-----------------------------------------------------------------------|
| [`hx-action`](https://four.htmx.org/reference/attributes/hx-action)     | Specify URL, with optional [`hx-method`](https://four.htmx.org/reference/attributes/hx-method). Supports progressive enhancement via native `action`/`method` fallback |
| [`hx-method`](https://four.htmx.org/reference/attributes/hx-method)     | Specify HTTP method (overrides native `method` and `formmethod`)      |
...
| [`htmx:finally:request`](https://four.htmx.org/reference/events/htmx-finally-request)             | When request completes, fails, or is cancelled |
...
| [`morphSkip`](https://four.htmx.org/reference/config/htmx-config-morphSkip)                 | `'[hx-morph-skip]'`            | CSS selector for elements to skip during morph                |
| [`morphSkipChildren`](https://four.htmx.org/reference/config/htmx-config-morphSkipChildren) | `'[hx-morph-skip-children]'`            | CSS selector for elements whose children to skip during morph |
...
Each attribute combines the URL and HTTP method. Alternatively, use [`hx-action`](https://four.htmx.org/reference/attributes/hx-action) and [`hx-method`](https://four.htmx.org/reference/attributes/hx-method) to separate them — useful when the method is dynamic, or when you want progressive enhancement with native `action`/`method` fallback.
...
You can use these features to implement many common UX patterns, such as [Active Search](https://four.htmx.org/patterns/active-search):
...
| swapEmpty    | true or false, whether to perform the main swap when the response body is empty (`false` skips it). Defaults to [`htmx.config.defaultSwapEmpty`](https://four.htmx.org/reference/config/htmx-config-defaultSwapEmpty) |
...
Another use case is to [reset user input](https://four.htmx.org/patterns/reset-on-submit) on successful requests using the [`htmx:after:swap`](https://four.htmx.org/reference/events/htmx-after-swap)
event:
...
This is the opposite default to [`hx-swap-oob`](https://four.htmx.org/reference/attributes/hx-swap-oob): with partials, an
...
Or set the global default via [`htmx.config.defaultSwapEmpty`](https://four.htmx.org/reference/config/htmx-config-defaultSwapEmpty).
...
**Use [`hx-swap-oob`](https://four.htmx.org/reference/attributes/hx-swap-oob)** for simple ID-based updates.

**Use [`<hx-partial>`](https://four.htmx.org/reference/tags/hx-partial)** for everything else.
...
- [`hx-vals`](https://four.htmx.org/reference/attributes/hx-vals)
- [`hx-config`](https://four.htmx.org/reference/attributes/hx-config)
...
`hx-target` only resolves to a single element. To swap the same response into multiple elements, use the [`hx-targets`](https://four.htmx.org/extensions/hx-targets) extension attribute:

```html
<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/ext/hx-targets.js"></script>

<button hx-get="/data" hx-targets="#results, #cache">Load</button>
```

See the [hx-targets extension docs](https://four.htmx.org/extensions/hx-targets) for full details.
...
```html
<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/htmx.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/htmx.org@4.0.0-beta6/dist/ext/hx-sse.js"></script>
```
...
| `htmx_finally_request` | [`htmx:finally:request`](https://four.htmx.org/reference/events/htmx-finally-request) | `(elt, detail)` | When request completes, fails, or is cancelled |
...
| `htmx_finally_swap` | [`htmx:finally:swap`](https://four.htmx.org/reference/events/htmx-finally-swap) | `(elt, detail)` | After swap (success or error) |
